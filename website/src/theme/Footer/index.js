...
function TermAndPrivacy() {
  return (
    <>
      <a
        className={styles.navFooterText}
...
function Footer() {
  ...
  const yoctolAILogoUrl = useBaseUrl('/img/yoctol_ai_logo.svg');

  return (
    <footer className={`footer ${styles.navFooter}`}>
      <div className={styles.footerLayout}>
        <div>
          <div style={{ marginBottom: 16 }}>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img width="104px" src={yoctolAILogoUrl} alt="YOCTOL.AI" />
            </a>
          </div>
          <div className={styles.desktop}>
            <p className={styles.navFooterText}>{copyright}</p>
        ...
        <div className={styles.footerMedias}>
          <h4 className={styles.navFooterTitle}>Social Media</h4>
        ...
        <div className={styles.footerProduct}>
          <h4 className={styles.navFooterTitle}>Product</h4>
          <div className={styles.icons}>
            <a
