declare module 'react-spring' {
  ...
  export class Spring<
    S extends object,
    DS extends object
  > extends PureComponent<SpringProps<S, DS> & S> {}
  ...
  export function animated<C>(component: any): any;

  namespace animated {
    export const div: ComponentClass<JSX.IntrinsicElements['div']>;
  }
  ...
  > extends PureComponent<KeyframesProps<S, DS> & S> {
    ...
    static Transition<S extends object, DS extends object>(
      ...
      | S
      | Pick<
          TransitionProps<S, DS>,
          Exclude<keyof TransitionProps<S, DS>, 'to'>
        >,
      DS
    >;
  }
